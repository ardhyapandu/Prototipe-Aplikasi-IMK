...
<div class="box">
	...
	<h4>
		...
		<div class="pull-right">
			...
			<a href="add_book.php" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i>Tambah Buku</a>
		</div>
	</h4>
			...
			<tbody style="text-align: center; color: black;">
				<tr>
					...
					<td class="text-center">
						<a href="up_book.php" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
